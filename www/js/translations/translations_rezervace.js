const translations = {
  ...
  cz: {
    ...
    btn_submit: "Odeslat",
    value1: "Prodloužený víkend ve Stolových horách",
...
function changeLanguage(language) {
  ...
  document.getElementById("placeHolder_telefon").innerHTML =
    translations[language].placeHolder_telefon;
  document.getElementById("placeHolder_date").innerHTML =
    translations[language].placeHolder_date;
  document.getElementById("placeHolder_package").innerHTML =
    translations[language].placeHolder_package;
